...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/drugBasic/controller/drugBasicEdit.js"></script>
</head>
<body>
	<!--子页面begin-->
				...
				<ul>
					<li>
	                	...
	                	<input type="hidden" id="id" value="${id}">
	                        <button class="btn btn-orange" id="updateDrugBasic"><i class="fa fa-save"></i>保存</button>

...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/drugInStorage/controller/drugInStorageAdd.js"></script>
</head>
<body>
	<!--子页面begin-->
				...
				<ul>
	                <li>
	                    ...
	                    <div class="form-content clearfix">
	                        <button class="btn btn-orange" id="addDrugInStorage"><i class="fa fa-save"></i>保存</button>

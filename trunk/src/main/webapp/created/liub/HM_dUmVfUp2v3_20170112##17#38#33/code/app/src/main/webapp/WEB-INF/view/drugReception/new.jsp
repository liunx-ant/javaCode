...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/drugReception/controller/drugReceptionAdd.js"></script>
</head>
<body>
	<!--子页面begin-->
				...
				<ul>
	                <li>
	                    ...
	                    <div class="form-content clearfix">
	                        <button class="btn btn-orange" id="addDrugReception"><i class="fa fa-save"></i>保存</button>

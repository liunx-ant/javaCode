...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/drugManager/controller/drugManagerEdit.js"></script>
</head>
<body>
	<!--子页面begin-->
				...
				<ul>
					<li>
	                	...
	                	<input type="hidden" id="id" value="${id}">
	                        <button class="btn btn-orange" id="updateDrugManager"><i class="fa fa-save"></i>保存</button>

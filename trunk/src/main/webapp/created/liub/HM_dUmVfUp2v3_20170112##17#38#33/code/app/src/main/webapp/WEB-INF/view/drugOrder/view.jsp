...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/drugOrder/controller/drugOrderInfo.js"></script>
</head>
<body>
	<!--子页面begin-->
		...
		<div class="right-form mt0">
			<form onsubmit="return false;">
				...
				<ul class="w100">	
					...
					<li >
					    <label class="ser-label">采购单号：</label>
					    <div class="form-content">
					...
					<li >
					    ...
					    <div class="form-content">
						<input readonly class="inputText " maxlength=64 name="department" type="text">
					...
					<li >
					    ...
					    <div class="form-content">
						<input readonly class="inputText " maxlength=64 name="departmentName" type="text">
			            
					    </div>
					</li>

					<li >
					    <label class="ser-label">申请人id：</label>
					    <div class="form-content">
						<input readonly class="inputText " maxlength=64 name="applicant" type="text">
			            
					    </div>
					</li>

					<li >
					    <label class="ser-label">申请人名称：</label>
					    <div class="form-content">
						<input readonly class="inputText " maxlength=64 name="applicantName" type="text">
			            
					    </div>
					</li>

					<li >
					    <label class="ser-label">申请时间：</label>
					    <div class="form-content">
						<input readonly class="inputText " maxlength=19 name="applicantTime" type="text">
					...
					<li >
					    <label class="ser-label">入库状态：</label>
					    <div class="form-content">
						<input readonly class="inputText " maxlength=11 name="inventoryStatus" type="text">

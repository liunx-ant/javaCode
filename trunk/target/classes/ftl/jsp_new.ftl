...
<script type="text/javascript" src="${r'${pageContext.request.contextPath}'}/js/${mainObject.objectName}/controller/${mainObject.objectName}Add.js"></script>
</head>
<body>
	<!--子页面begin-->
	...
	<#list mainObject.objectRels as objectRel>
		<#if ! object.isMain && objectRel.relType == 'ONETOONE'>
			<#list object.properties as property>
							...
							<#include "/form/subPage/addPageBtn.ftl"/>

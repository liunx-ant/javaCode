...
<script type="text/javascript" src="${r'${pageContext.request.contextPath}'}/js/${mainObject.objectName}/controller/${mainObject.objectName}Info.js"></script>
</head>
<body>
	<!--子页面begin-->
...
<#list objects as object>
	<#if object.isMain>
		<#list object.properties as property>
							<#include "/form/subPage/viewElement.ftl"/>
		</#list>
	</#if>
	<#list mainObject.objectRels as objectRel>
		<#if ! object.isMain && objectRel.relType == 'ONETOONE'>
			<#list object.properties as property>
							...
							<#include "/form/subPage/viewPageBtn.ftl"/>
    <!--子页面end-->
